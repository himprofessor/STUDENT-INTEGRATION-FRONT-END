<template>
    <section class="bg-002 text-white my-10">
        <div>
            <h1 class="p-4 text-center lg:text-3xl md:text-2xl text-xl font-bold text-white">
            Impact
            </h1>       
            <p class="flex whitespace-normal break-all text-center mx-3 justify-center text-white whitespace-normal flex-wrap font-normal lg:text-xl sm:px-16 xl:px-47">
        ...
        <div class="w-full flex flex-wrap dark:text-white text-center justify-center">
            <div class="pair-container lg:w-[18%] md:w-[45%] w-full">
                <div class="my-5">
                    <div class="card-image mb-5 w-36 h-36 rounded-full outline-none border-gray-200 bg-gray-300 border-2 flex items-center justify-center m-auto">
                        <svg xmlns="http://www.w3.org/2000/svg" height="72" width="72" viewBox="0 0 640 512">
                    ...
                    <p class="mb-2 text-3xl md:text-2xl ">1691</p>
                    <p>graduates</p> 
                </div>                  
            </div>
            ...
            <div class="pair-container lg:w-[18%] md:w-[45%] w-full">
                <div class="my-5">
                    <div class="card-image mb-5 w-36 h-36 rounded-full outline-none border-gray-200 bg-gray-300 border-2 flex items-center justify-center m-auto">
                        <svg class="h-16 w-16 text-black" width="20" height="20" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <p class="mb-2 text-3xl md:text-2xl ">388 $</p>
                    <p>the graduate's average monthly wage (USD)</p>
                </div>
            </div>
            ...
            <div class="pair-container lg:w-[18%] md:w-[45%] w-full">
                <div class="my-5">
                    ...
                    <p class="mb-2 text-3xl md:text-2xl">100 $</p>
                    <p>graduates employed within 3 months of graduation</p>
                </div>
            </div>
            ...
            <div class="pair-container lg:w-[18%] md:w-[45%] w-full">
                <div class="my-5">
                    <div class="card-image mb-5 w-36 h-36 rounded-full outline-none border-gray-200 bg-gray-300 border-2 flex items-center justify-center m-auto">
                        <svg class="h-16 w-16 text-black" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <rect x="2" y="3" width="20" height="14" rx="2" ry="2" />
                            <line x1="8" y1="21" x2="16" y2="21" />
                            <line x1="12" y1="17" x2="12" y2="21" />
                        </svg>                
                    </div>
                    <p class="mb-2 text-3xl md:text-2xl">98 $</p>
                    <p>of our graduates work in the IT sector</p>
                </div>
            </div>
        </div>
    </section>
