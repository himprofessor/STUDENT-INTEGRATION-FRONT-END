<template>
    <section class="bg-002 text-white my-10">
        ...
        <div class="w-full flex flex-wrap dark:text-white text-center justify-center">
            <div class="pair-container lg:w-[25%] md:w-[45%] w-full">
                <div class="my-5">
                    <div class="card-image mb-5 w-36 h-36 rounded-full outline-none border-gray-200 bg-gray-300 border-2 flex items-center justify-center m-auto">
                        <svg xmlns="http://www.w3.org/2000/svg" height="96" width="96" viewBox="0 0 640 512">
            ...
            <div class="pair-container lg:w-[25%] md:w-[45%] w-full">
                <div class="my-5">
                    <div class="card-image mb-5 w-36 h-36 rounded-full outline-none border-gray-200 bg-gray-300 border-2 flex items-center justify-center m-auto">
                        <svg class="h-20 w-20 text-black" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="pair-container lg:w-[25%] md:w-[45%] w-full">
                <div class="my-5">
                    <div class="card-image mb-5 w-36 h-36 rounded-full outline-none border-gray-200 bg-gray-300 border-2 flex items-center justify-center m-auto">
                        <svg class="h-20 w-20 text-black" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
